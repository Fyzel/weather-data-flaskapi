...
"""
create_weather_data_api_user -- create a weather data api user

create_weather_data_api_user is a command line utility to create a new user in the application's database.
